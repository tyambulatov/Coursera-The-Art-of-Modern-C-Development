...
public:
    ReadingManager()
        ...
        : user_page_counts_(MAX_USER_COUNT_ + 1, -1),     // O(U)
          page_achieved_by_count_(MAX_PAGE_COUNT_ + 1, 0) // O(L)
                                                          // O(L + U)
    {
    }

    void Read(int user_id, int page_count) // Q
    {
...
private:
    ...
    static const int MAX_PAGE_COUNT_ = 13;
